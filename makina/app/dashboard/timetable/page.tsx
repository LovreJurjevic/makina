    ...
    useEffect(() => {
        async function loadOrderData() {
            const [ve, em] = await Promise.all([
                supabase.from('vehicles').select('id, registration, make, model, clients(name, surname)'),
        ...
        <div className="p-8 space-y-8">
            <div>
                ...
                <p className="text-slate-500 font-bold text-[10px] uppercase tracking-[0.3em] mt-2">
                    Upravljajte događajima
                </p>
            </div>

            <div className="flex flex-col lg:flex-row gap-8 max-w-[1600px] mx-auto min-h-[80vh]">
                {/* CALENDAR SECTION */}
                        ...
                        {days.map(day => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`min-h-[120px] p-4 border-b border-r border-slate-100 flex flex-col justify-between transition-all relative
                                ...
                                >
                                    <div className="flex justify-between items-start">
                                        ...
                                        {isTodayDay && (
                                            <div className={`w-2 h-2 rounded-full ${isSelected ? 'bg-white' : 'bg-yellow-400'}`} />
                                        )}
                                    </div>
                                    {count > 0 && (
                ...
                <div className="w-full lg:w-96 space-y-6">
                    <div className="bg-white rounded-[2.5rem] p-8 border-2 border-slate-100 shadow-xl min-h-[500px]">
                        ...
                        <div className="space-y-4">
                            {dayReservations.length === 0 ? (
                                ...
                                <div key={res.id} className="p-5 bg-slate-50 rounded-3xl border border-slate-100">
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
                        <div className="bg-white w-full max-w-lg rounded-[3rem] shadow-2xl overflow-hidden">
                            ...
                            <div className="p-8 space-y-6 text-left">
                                ...
                                <button onClick={handleAddReservation} className="w-full h-16 bg-blue-600 text-white rounded-2xl font-black uppercase tracking-[0.2em] hover:bg-blue-700 transition-all shadow-lg shadow-blue-100">
                                    SPREMI REZERVACIJU
                                </button>
                            </div>
                        </div>
